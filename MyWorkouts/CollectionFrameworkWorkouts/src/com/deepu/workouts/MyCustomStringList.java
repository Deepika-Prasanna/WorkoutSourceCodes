...
public class MyCustomStringList<T> implements List<T>{
	...
	public static void main(String[] args) {
		...
		anotherList.add(4, "EEE");
		System.out.println("After calling add index with element");
		for(String str : anotherList) {
			System.out.println(str);
		}
		
		MyCustomStringList<String> anotherList1 = new MyCustomStringList<String>();
		anotherList1.addAll(myList);
		anotherList1.add("BBB");
		System.out.println("AnotherList1 ");
		for(String str : anotherList1) {
			System.out.println(str);
		}
		
		System.out.println("Last index of BBB is " + anotherList1.lastIndexOf("BBB"));
		
		anotherList.remove(1);
		System.out.println("After calling remove by index");
		for(String str : anotherList) {
			System.out.println(str);
		}
		
		System.out.println("Index of DDD " + anotherList.indexOf("DDD"));
